...
MAKE_SIGNATURE(CNetGraphPanel_DrawTextFields_GetClientInterpAmount_Call1, "client.dll", "F3 41 0F 59 C1 4C 63 02", 0x0);
MAKE_SIGNATURE(CNetGraphPanel_DrawTextFields_GetClientInterpAmount_Call2, "client.dll", "0F 28 F8 0F 2F 3D ? ? ? ? 73", 0x0);
